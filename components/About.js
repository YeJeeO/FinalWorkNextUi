    ...
    return (
      <div className="header">
        <div className="space-y-2">
          <h1> Наша студия</h1>
          <p className="purple-dark text-foreground bg-background" > Танцевальная студия г. Новосибирск
...
Детская хореографическая студия в Новосибирске
        ...
        <div className="flex h-5 items-center space-x-4 text-medium">
          <div> Заниматься хореографией можно с 3 лет. Наши преподаватели могут многому научить. 
